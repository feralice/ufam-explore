        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.text}>
              Os serviços do Ufam Explore são fornecidos pelas pessoas físicas
              com os seguintes nomes: Fernanda Alice Farias Duarte inscrito no
              CPF sob o n° ***.***.***-51, Jo Pereira dos Santos inscrito no CPF
              sob o n° ***.***.***-26, Keren Guimarães Góes inscrito no CPF sob
              o n° ***.***.***-80, Nilton da Silva Nascimento inscrito no CPF
              sob o n° ***.***.***-93 e Sarah Julia Rolim dos Santos inscrito no
              CPF sob o n° ***.***.***-02, titulares da propriedade intelectual
            ...
            <Text style={styles.text}>
              ...
              usuários. A plataforma caracteriza-se pela prestação do seguinte
              serviço: Divulgação de eventos e oportunidades na universidade,
              permitindo criação de publicações para eventos, interações com as
              publicações e adicionar eventos à calendários virtuais.
            </Text>
            ...
            <Text style={styles.text}>
              ...
              as pessoas físicas ou jurídicas, usuárias do aplicativo. Ao
              ...
              penalidades cabíveis. A aceitação do presente instrumento é
            ...
            <Text style={styles.text}>
              ...
              escolhidos, o pagamento de determinado valor. Ao se cadastrar o
              ...
              dados fornecidos. O usuário se compromete a não informar seus
              ...
              plena capacidade civil sem a prévia autorização. Mediante a
              realização do cadastro o usuário declara e garante expressamente
              ser plenamente capaz, podendo exercer e usufruir livremente dos
              serviços e produtos. O usuário deverá fornecer um endereço de
              e-mail válido, através do qual o site realizará todas comunicações
              necessárias. Após a confirmação do cadastro, o usuário possuirá um
              login e uma senha pessoal, a qual assegura ao usuário o acesso
              individual à mesma. Desta forma, compete ao usuário exclusivamente
              a manutenção de referida senha de maneira confidencial e segura,
              evitando o acesso indevido às informações pessoais. Toda e
              qualquer atividade realizada com o uso da senha será de
              responsabilidade do usuário, que deverá informar prontamente em
              caso de uso indevido da respectiva senha. Não será permitido
              ceder, vender, alugar ou transferir, de qualquer forma, a conta,
              que é pessoal e intransferível. Caberá ao usuário assegurar que o
              seu equipamento seja compatível com as características técnicas
              que viabilizem a utilização da plataforma e dos serviços ou
              produtos. O usuário poderá, a qualquer tempo, requerer o
              cancelamento de seu cadastro junto ao aplicativo Ufam Explore. O
              seu descadastramento será realizado o mais rapidamente possível,
              ...
              ceder ou utilizar as informações derivadas do uso dos serviços, do
              site e quaisquer plataformas, incluindo todas as informações
            ...
            <Text style={styles.text}>
              ...
              através do email jo.pereira@icomp.ufam.edu.br. Estes serviços de
              atendimento ao usuário estarão disponíveis nos seguintes dias e
              horários: Segunda a Sexta, 09h-17h.
            </Text>
            <Text style={styles.smallTitle}>6. Das responsabilidades</Text>
            <Text style={styles.text}>
              É de responsabilidade do usuário: a) defeitos ou vícios técnicos
              originados no próprio sistema do usuário; b) a correta utilização
              da plataforma, dos serviços ou produtos oferecidos, prezando pela
              ...
              Privacidade e na legislação nacional e internacional; d) pela
              proteção aos dados de acesso à sua conta/perfil (login e senha). É
              de responsabilidade da plataforma Ufam Explore: a) indicar as
              ...
              dado causa; c) as informações que foram por ele divulgadas, sendo
              que os comentários ou informações divulgadas por usuários são de
              inteira responsabilidade dos próprios usuários; d) os conteúdos ou
              atividades ilícitas praticadas através da sua plataforma. A
              plataforma não se responsabiliza por links externos contidos em
              seu sistema que possam redirecionar o usuário à ambiente externo a
              sua rede. Não poderão ser incluídos links externos ou páginas que
            ...
            <Text style={styles.text}>
              ...
              disponibilizados. A estrutura do site ou aplicativo, as marcas,
              ...
              computador, banco de dados, arquivos de transmissão e quaisquer
              outras informações e direitos de propriedade intelectual de Jo
              Pereira dos Santos, observados os termos da Lei da Propriedade
              Industrial (Lei nº 9.279/96), Lei de Direitos Autorais (Lei n°
              9.610/98) e Lei do Software (Lei n° 9.609/98), estão devidamente
              reservados. Este Termo de Uso não cede ou transfere ao usuário
              qualquer direito, de modo que o acesso não gera qualquer direito
              de propriedade intelectual ao usuário, exceto pela licença
              limitada ora concedida. O uso da plataforma pelo usuário é
              pessoal, individual e intransferível, sendo vedado qualquer uso
              não autorizado, comercial ou não-comercial. Tais usos consistirão
              em violação dos direitos de propriedade intelectual de Jo Pereira
              dos Santos, puníveis nos termos da legislação aplicável.
            </Text>
            <Text style={styles.smallTitle}>8. Das sanções</Text>
            <Text style={styles.text}>
              Sem prejuízo das demais medidas legais cabíveis, Jo Pereira dos
              Santos poderá, a qualquer momento, advertir, suspender ou cancelar
              a conta do usuário: a) que violar qualquer dispositivo do presente
              Termo; b) que descumprir os seus deveres de usuário; c) que tiver
              qualquer comportamento fraudulento, doloso ou que ofenda a
              terceiros.
            </Text>
            ...
            <Text style={styles.text}>
              ...
              imediata rescisão unilateral por parte de Jo Pereira dos Santos e
              o bloqueio de todos os serviços prestados ao usuário.
            </Text>
            <Text style={styles.smallTitle}>10. Das alterações</Text>
            <Text style={styles.text}>
              Os itens descritos no presente instrumento poderão sofrer
              alterações, unilateralmente e a qualquer tempo, por parte de Jo
              Pereira dos Santos, para adequar ou modificar os serviços, bem
              como para atender novas exigências legais. As alterações serão
              veiculadas pelo aplicativo Ufam Explore e o usuário poderá optar
